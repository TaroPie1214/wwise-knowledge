# Contents Editor: Main Audio, Audio, and Auxiliary Busses

[Wwise 帮助文档](../../../../00-Wwise-帮助文档.md) > [参考主题](../../../00-参考主题.md) > [Project Explorer](../../00-Project-Explorer.md) > [Audio tab](../00-Audio-tab.md) > [Busses hierarchy](00-Busses-hierarchy.md) > Contents Editor: Main Audio, Audio, and Auxiliary Busses

#### Contents Editor: Main Audio, Audio, and Auxiliary Busses

This Contents Editor gives you quick access to some of the most common properties associated with the child busses of the selected Main Audio, Audio, or Auxiliary Bus.
