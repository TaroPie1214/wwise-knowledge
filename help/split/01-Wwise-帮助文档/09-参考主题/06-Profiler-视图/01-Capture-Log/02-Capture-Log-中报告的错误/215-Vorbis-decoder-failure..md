...
[Wwise 帮助文档](../../../../00-Wwise-帮助文档.md) > [参考主题](../../../00-参考主题.md) > [Profiler 视图](../../00-Profiler-视图.md) > [Capture Log](../00-Capture-Log.md) > [Capture Log 中报告的错误](00-Capture-Log-中报告的错误.md) > Vorbis decoder failure.

#### Vorbis decoder failure.

“Vorbis 解码器故障”。Vorbis 解码器遇到了损坏的流，无法继续解码声音。声音会停止播放。
