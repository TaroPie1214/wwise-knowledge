...
[选项架构](ak_wwise_core_switchcontainer_assignmentadded_options_schema.html)

# 发布

| 名称 | 类型 | 说明 |
| --- | --- | --- |
| **switchContainer** \* | object | 该 Switch Container 添加了指派。  Wwise 对象。使用 return 选项来指定所需的属性。 |
...
[发布架构](ak_wwise_core_switchcontainer_assignmentadded_publish_schema.html)
