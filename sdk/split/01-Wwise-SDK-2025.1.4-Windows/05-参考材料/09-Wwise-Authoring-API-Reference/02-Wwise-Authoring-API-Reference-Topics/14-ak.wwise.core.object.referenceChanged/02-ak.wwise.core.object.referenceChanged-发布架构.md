# ak.wwise.core.object.referenceChanged 发布架构
...
"description": "发生更改的引用的名称。如需查看对象的可用引用，请参阅 wobjects.xml 中对对象的描述。"
...
"description": "若针对单个平台更改了引用，则为平台的 ID (GUID)。若未提供，则针对所有平台更改引用。\\n 以下形式的对象 GUID：{aabbcc00-1122-3344-5566-77889900aabb}。"
