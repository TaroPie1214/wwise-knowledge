...
[选项架构](ak_wwise_ui_selectionchanged_options_schema.html)
...
| objects **[...]** | object | 选定对象。您可以使用选项来指定所要返回的数据。默认返回 ID 和名称。  Wwise 对象。使用 return 选项来指定所需的属性。 |
...
[发布架构](ak_wwise_ui_selectionchanged_publish_schema.html)
