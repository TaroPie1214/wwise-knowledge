...
[选项架构](ak_wwise_ui_getselectedobjects_options_schema.html)

# 结果

| 名称 | 类型 | 说明 |
| --- | --- | --- |
| **objects** \* | array | 选定对象，采用选项中指定的格式。若未选中任何对象，则可为空。 |
| objects **[...]** | object | 选定对象。使用选项来指定所要返回的数据。默认返回 ID 和名称。  Wwise 对象。使用 return 选项来指定所需的属性。 |
...
[结果架构](ak_wwise_ui_getselectedobjects_result_schema.html)
