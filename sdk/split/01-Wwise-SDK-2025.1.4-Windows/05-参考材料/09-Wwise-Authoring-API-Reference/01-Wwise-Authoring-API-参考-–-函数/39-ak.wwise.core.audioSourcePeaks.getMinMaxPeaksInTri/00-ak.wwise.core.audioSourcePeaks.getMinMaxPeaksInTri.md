...
| 名称 | 类型 | 说明 |
| --- | --- | --- |
| **object** \* |  | 音频源的 ID (GUID)、名称或路径。  Any of: |
...
[参数架构](ak_wwise_core_audiosourcepeaks_getminmaxpeaksintrimmedregion_args_schema.html)
...
[结果架构](ak_wwise_core_audiosourcepeaks_getminmaxpeaksintrimmedregion_result_schema.html)
