...
**`WwiseConsole migrate "C:\MyProject\MyProject.wproj" --verbose`**
...
[参数架构](ak_wwise_cli_migrate_args_schema.html)
...
[选项架构](ak_wwise_cli_migrate_options_schema.html)

# 结果

WwiseConsole.exe 退出代码为 0 表示成功，为 1 表示至少出现了一项错误并可能出现了警告，为 2 表示仅出现了警告。

[结果架构](ak_wwise_cli_migrate_result_schema.html)
