...
| **ControlInput** | Control Input | Reference |  | **可能的类型：**   |  | | --- | | ModulatorLfo | | ModulatorEnvelope | | ModulatorTime | | GameParameter | | MidiParameter | | true |  |  |
| **Curve** | Curve | Reference |  | **可能的类型：**   |  | | --- | | Curve |     **不得为 Null** | false |  |  |
| **OverrideColor** | Override Color | bool | false | None | true | None | false |
| **PropertyName** | Property | string |  | None | false | None | false |