...
| **GlobalOrPerObject** | Scope | int16 | 1 | **可能的值：**   |  |  | | --- | --- | | 值 | 显示名称 | | 0 | Game object | | 1 | Global | | true | None | false |
...
| **MidiPlayOnNoteType** | MIDI Play On | int16 | 1 | **可能的值：**   |  |  | | --- | --- | | 值 | 显示名称 | | 1 | Note-On | | 2 | Note-Off | | true | None | false |
| **MidiTrackingRootNote** | MIDI Note Tracking Root | int32 | 60 | [ 0 , 127 ] | true | None | false |
...
| **PlayMechanismInfiniteOrNumberOfLoops** | Loop Infinite | int16 | 1 | **可能的值：**   |  |  | | --- | --- | | 值 | 显示名称 | | 0 | No. of Loops | | 1 | Infinite | | true | None | false |
...
| **PlayMechanismSpecialTransitionsType** | Transition Type | int16 | 0 | **可能的值：**   |  |  | | --- | --- | | 值 | 显示名称 | | 0 | Xfade (amp) | | 4 | Xfade (power) | | 1 | Delay | | 2 | Sample accurate | | 3 | Trigger rate | | true | None | false |
...
| **Playlist** | Playlist | List |  | **可能的类型：**   |  | | --- | | PlaylistSlot | |  |  |  |
...
| **RandomOrSequence** | Play Type | int16 | 1 | **可能的值：**   |  |  | | --- | --- | | 值 | 显示名称 | | 0 | Sequence | | 1 | Random | | true | None | false |
...
| **RestartBeginningOrBackward** | At End of Playlist | int16 | 1 | **可能的值：**   |  |  | | --- | --- | | 值 | 显示名称 | | 0 | Play in reverse order | | 1 | Restart | | true | None | false |
