# Windows 和 Windows UWP 2021.1.7
...
以下各节列举并阐述了 2021.1.6 和 2021.1.7 版本之间针对 Wwise 所作的 Windows 和 Windows UWP 特定改进。有关常规版本说明的信息，请参阅 [版本说明 2021.1.7](whatsnew_2021_1_7.html) 章节。

- [漏洞修复](windows_releasenotes_2021_1_7.html#windows_bugs_2021_1_7)
- [社区报告的漏洞修复](windows_releasenotes_2021_1_7.html#windows_community_bugs_2021_1_7)
...
- **WG-58072** 已修复：在采用固定比率重采样器 AVX2 编码时可能会出现内存访问冲突。
- **WG-58477** 已修复：在反复尝试而无法初始化设备 ID 为 0 的 Wwise Motion 输出设备时生成了过多的日志。