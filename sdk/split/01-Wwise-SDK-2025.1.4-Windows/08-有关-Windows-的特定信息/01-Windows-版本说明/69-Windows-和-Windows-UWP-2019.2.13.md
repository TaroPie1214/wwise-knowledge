# Windows 和 Windows UWP 2019.2.13
...
以下各节列举并阐述了 2019.2.12 和 2019.2.13 版本之间针对 Wwise 所作的 Windows 和 Windows UWP 特定改进。有关常规版本说明的信息，请参阅 [版本说明 2019.2.13](whatsnew_2019_2_13.html) 章节。

- [社区报告的漏洞修复](windows_releasenotes_2019_2_13.html#windows_community_bugs_2019_2_13)

# 社区报告的漏洞修复

- **WG-55942** 已修复：在采用非 2D 扬声器配置的情况下调用 `IAkMixerPluginContext::ComputePlanarVBAPGains` 会导致结果不一致或发生崩溃。在扬声器配置无效时，该函数现在会返回 AK\_Fail。