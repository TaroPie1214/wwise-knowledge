# Windows 和 Windows UWP 2022.1.7
...
以下各节列举并阐述了 2022.1.6 和 2022.1.7 版本之间针对 Wwise 所作的 Windows 和 Windows UWP 特定改进。有关常规版本说明的信息，请参阅 [版本说明 2022.1.7](whatsnew_2022_1_7.html) 章节。

- [其他改进](windows_releasenotes_2022_1_7.html#windows_misc_2022_1_7)

# 其他改进

- **WG-66958** 现在会对 [Microsoft](namespace_microsoft.html) 平台的二进制文件进行代码签名。