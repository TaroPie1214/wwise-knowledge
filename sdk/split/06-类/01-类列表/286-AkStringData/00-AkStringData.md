...
[所有成员列表](class_ak_string_data-members.html) |
[Public 成员函数](#pub-methods) |
[Protected 属性](#pro-attribs)

AkStringData< TAlloc, T\_CHAR > 模板类 参考

`#include <AkString.h>`

类 AkStringData< TAlloc, T\_CHAR > 继承关系图:

![](../../../images/class_ak_string_data.png)
...
### template<typename TAlloc, typename T\_CHAR> class AkStringData< TAlloc, T\_CHAR >

在文件 [AkString.h](_ak_string_8h_source.html) 第 [33](_ak_string_8h_source.html#l00033) 行定义.