...
[所有成员列表](structak__wwise__plugin__media__converter__v1-members.html) |
[Public 类型](#pub-types) |
[Public 成员函数](#pub-methods) |
[Public 属性](#pub-attribs)

ak\_wwise\_plugin\_media\_converter\_v1结构体 参考

API to convert used object medias to a format usable by the plug-in's Sound Engine part.
[更多...](structak__wwise__plugin__media__converter__v1.html#details)

`#include <MediaConverter.h>`

类 ak\_wwise\_plugin\_media\_converter\_v1 继承关系图:

![](../../../images/structak__wwise__plugin__media__converter__v1.png)
...
在文件 [MediaConverter.h](_media_converter_8h_source.html) 第 [40](_media_converter_8h_source.html#l00040) 行定义.