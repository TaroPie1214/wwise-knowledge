...
[所有成员列表](structak__wwise__plugin__notifications__object__store__v1-members.html) |
[Public 类型](#pub-types) |
[Public 成员函数](#pub-methods) |
[Public 属性](#pub-attribs)

ak\_wwise\_plugin\_notifications\_object\_store\_v1结构体 参考

Interface able to receive notifications for custom inner property sets.
[更多...](structak__wwise__plugin__notifications__object__store__v1.html#details)

`#include <HostObjectStore.h>`

类 ak\_wwise\_plugin\_notifications\_object\_store\_v1 继承关系图:

![](../../../images/structak__wwise__plugin__notifications__object__store__v1.png)
...
在文件 [HostObjectStore.h](_host_object_store_8h_source.html) 第 [295](_host_object_store_8h_source.html#l00295) 行定义.