...
[所有成员列表](structak__wwise__plugin__notifications__reference__set__v1-members.html) |
[Public 类型](#pub-types) |
[Public 成员函数](#pub-methods) |
[Public 属性](#pub-attribs)

ak\_wwise\_plugin\_notifications\_reference\_set\_v1结构体 参考

`#include <HostReferenceSet.h>`

类 ak\_wwise\_plugin\_notifications\_reference\_set\_v1 继承关系图:

![](../../../images/structak__wwise__plugin__notifications__reference__set__v1.png)
...
在文件 [HostReferenceSet.h](_host_reference_set_8h_source.html) 第 [213](_host_reference_set_8h_source.html#l00213) 行定义.