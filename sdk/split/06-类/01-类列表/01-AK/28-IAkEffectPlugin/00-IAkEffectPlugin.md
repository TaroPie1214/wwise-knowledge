...
[所有成员列表](class_a_k_1_1_i_ak_effect_plugin-members.html) |
[Public 成员函数](#pub-methods) |
[Protected 成员函数](#pro-methods)

AK::IAkEffectPlugin类 参考abstract

Software effect plug-in interface (see [创建声音引擎效果器插件](soundengine_plugins_effects.html)).
[更多...](class_a_k_1_1_i_ak_effect_plugin.html#details)

`#include <IAkPlugin.h>`

类 AK::IAkEffectPlugin 继承关系图:

![](../../../../images/class_a_k_1_1_i_ak_effect_plugin.png)
...
在文件 [IAkPlugin.h](_i_ak_plugin_8h_source.html) 第 [847](_i_ak_plugin_8h_source.html#l00847) 行定义.