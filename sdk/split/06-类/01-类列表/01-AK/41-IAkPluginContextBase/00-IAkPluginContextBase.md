...
[所有成员列表](class_a_k_1_1_i_ak_plugin_context_base-members.html) |
[Public 成员函数](#pub-methods) |
[Protected 成员函数](#pro-methods)

AK::IAkPluginContextBase类 参考abstract

Interface to retrieve contextual information available to all types of plugins.
[更多...](class_a_k_1_1_i_ak_plugin_context_base.html#details)

`#include <IAkPlugin.h>`

类 AK::IAkPluginContextBase 继承关系图:

![](../../../../images/class_a_k_1_1_i_ak_plugin_context_base.png)
...
在文件 [IAkPlugin.h](_i_ak_plugin_8h_source.html) 第 [236](_i_ak_plugin_8h_source.html#l00236) 行定义.