...
[所有成员列表](structak__wwise__plugin__frontend__v1-members.html) |
[Public 类型](#pub-types) |
[Public 成员函数](#pub-methods)

ak\_wwise\_plugin\_frontend\_v1结构体 参考

Frontend plug-in API for Audio plug-ins.
[更多...](structak__wwise__plugin__frontend__v1.html#details)

`#include <Frontend.h>`

类 ak\_wwise\_plugin\_frontend\_v1 继承关系图:

![](../../../images/structak__wwise__plugin__frontend__v1.png)
...
在文件 [Frontend.h](_frontend_8h_source.html) 第 [42](_frontend_8h_source.html#l00042) 行定义.