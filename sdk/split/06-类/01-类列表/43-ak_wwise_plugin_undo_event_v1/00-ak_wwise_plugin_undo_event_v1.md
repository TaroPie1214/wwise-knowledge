...
[所有成员列表](structak__wwise__plugin__undo__event__v1-members.html) |
[Public 类型](#pub-types) |
[Public 成员函数](#pub-methods) |
[Public 属性](#pub-attribs)

ak\_wwise\_plugin\_undo\_event\_v1结构体 参考

API to create a custom undo event in a plug-in.
[更多...](structak__wwise__plugin__undo__event__v1.html#details)

`#include <HostUndoManager.h>`

类 ak\_wwise\_plugin\_undo\_event\_v1 继承关系图:

![](../../../images/structak__wwise__plugin__undo__event__v1.png)
...
在文件 [HostUndoManager.h](_host_undo_manager_8h_source.html) 第 [41](_host_undo_manager_8h_source.html#l00041) 行定义.