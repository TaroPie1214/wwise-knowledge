...
[所有成员列表](structak__wwise__plugin__first__time__creation__message__v1-members.html) |
[Public 类型](#pub-types) |
[Public 成员函数](#pub-methods) |
[Public 属性](#pub-attribs)

ak\_wwise\_plugin\_first\_time\_creation\_message\_v1结构体 参考

Plug-in that provides a special usage message when first instantiated.
[更多...](structak__wwise__plugin__first__time__creation__message__v1.html#details)

`#include <FirstTimeCreationMessage.h>`

类 ak\_wwise\_plugin\_first\_time\_creation\_message\_v1 继承关系图:

![](../../../images/structak__wwise__plugin__first__time__creation__message__v1.png)
...
在文件 [FirstTimeCreationMessage.h](_first_time_creation_message_8h_source.html) 第 [40](_first_time_creation_message_8h_source.html#l00040) 行定义.