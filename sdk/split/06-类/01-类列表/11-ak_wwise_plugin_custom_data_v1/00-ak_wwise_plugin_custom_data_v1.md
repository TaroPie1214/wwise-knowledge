...
[所有成员列表](structak__wwise__plugin__custom__data__v1-members.html) |
[Public 类型](#pub-types) |
[Public 成员函数](#pub-methods) |
[Public 属性](#pub-attribs)

ak\_wwise\_plugin\_custom\_data\_v1结构体 参考

Backend API to load and save custom data in XML format.
[更多...](structak__wwise__plugin__custom__data__v1.html#details)

`#include <CustomData.h>`

类 ak\_wwise\_plugin\_custom\_data\_v1 继承关系图:

![](../../../images/structak__wwise__plugin__custom__data__v1.png)
...
|  |  |
| --- | --- |
|  | **备注:** In order to use the XML reader and writer instance, your plug-in must request the XML interface: [ak\_wwise\_plugin\_host\_xml\_v1](structak__wwise__plugin__host__xml__v1.html "API interface for XML-based plug-in persistence."). |

在文件 [CustomData.h](_custom_data_8h_source.html) 第 [50](_custom_data_8h_source.html#l00050) 行定义.